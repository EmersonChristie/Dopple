...
export default class Home extends Component {
  constructor(props) {
    ...
    //this.applySmartCrop = this.applySmartCrop.bind(this);
  }
  ...
  async handleUploadSuccess(filename) {
    try {
      ...
      console.log("image ref", this.state.imageRef);
  ...
  render() {
    const allImages = this.state.allPhotos.map(photo => {
      if (photo.similarImages) {
        console.log("similar images true");
        ...
        console.log("similar images false");

        this.dopples = (
          <div className="scrolling-wrapper">
            <div className="main-photo card-1 card loading-card" xs={4}>
              <RingLoader color={"#000"} loading={true} />
            </div>
            <div className="main-photo card-1 card loading-card" xs={4}>
              <RingLoader color={"#000"} loading={true} />
            </div>
      ...
      return (
        <div key={photo.id}>
          <div style={{ minHeight: "215px", borderTop: "1px solid lightgrey" }}>
            <i
