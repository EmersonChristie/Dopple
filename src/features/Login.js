...
const loginButtonUrl =
  "https://firebasestorage.googleapis.com/v0/b/dopple-app-1.appspot.com/o/google-icon.png?alt=media&token=88b66642-6348-4c72-9fc8-cc04fa63de93";
  ...
  <div className="login-container">
    <div onClick={handleGoogleLogin} className="login-button">
      <div className="login-wrapper">
        <div
          className="login-button-container google-logo"
          style={styles}
